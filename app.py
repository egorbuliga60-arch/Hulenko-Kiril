...
def generate_data(n=500):
    ...
    # Створюємо пул IP (щоб вони повторювались)
    ip_pool = [
    ...
    for _ in range(n):
        ip = np.random.choice(ip_pool)  # беремо IP з пулу → будуть повтори
